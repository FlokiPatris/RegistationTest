...
from test.constants.shared import WaitTime, FieldType
...
class RegistrationPage:
    ...
    def wait_until_loaded(self) -> None:
        # Uses the FORM_SELECTOR defined in RegistrationField for consistency.
        self.page.wait_for_selector(RegistrationField.FORM_SELECTOR, timeout=WaitTime.LONG)

    def _fill_input(self, selector: str, value: str) -> None:
        element = self.page.wait_for_selector(selector, timeout=WaitTime.LONG)
        element.fill(value)
    ...
    def validate_and_fill_field(self, selector: str, field_type: FieldType, value) -> None:
        ...
        # Optionally, if the firstName field requires selecting a title based on gender:
        elif field_type == FieldType.STRING and selector.endswith("#firstName") and value:
    ...
    def fill_form_field(self, field_key: str, value) -> None:
        # Use the auto-generated dictionary from RegistrationField.
